...
const spawnEvents = key => spawn(HANDLERS$1, key);
...
export { index$1 as AppUtils, CORE_STRATEGIES, FCL_REDIRECT_URL_PARAM_NAME, FCL_RESPONSE_PARAM_NAME, index as InteractionTemplateUtils, TransactionError, URL, VERSION, index$2 as WalletUtils, buildMessageHandler, discovery, events, execStrategy, getChainId, getCurrentUser, getExecHttpPost, getMutate, initServiceRegistry, isReactNative, normalizePollingResponse, pluginRegistry, query, serialize, serviceEndpoint, setIsReactNative, transaction as tx, verifyUserSignatures };
