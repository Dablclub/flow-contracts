...
access(all) contract nft: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-nft.createEmptyCollection(nftType: Type<@nft.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return nft.resolveContractView(resourceType: Type<@nft.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return nft.resolveContractView(resourceType: Type<@nft.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = nft.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource interface nftCollectionPublic {}

    access(all) resource Collection: NonFungibleToken.Collection, nftCollectionPublic {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@nft.NFT>()] = true
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            ...
            nft.emitNFTUpdated(authTokenRef)
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&nft.Collection>(),
                    publicLinkedType: Type<&nft.Collection>(),
    ...
    init() {
        ...
        let collectionCap = self.account.capabilities.storage.issue<&nft.Collection>(self.CollectionStoragePath)
